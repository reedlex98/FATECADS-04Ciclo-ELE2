...
public class Formulario {
    ...
    private void inicializarComponentes() {
        ...
        // cria ButtonGroup para impedir que mais de um RadionButton seja selecionado
        ButtonGroup btgCidades = new ButtonGroup();
        btgCidades.add(rdbSantos);
        btgCidades.add(rdbSV);
        btgCidades.add(rdbGuaruja);
        btgCidades.add(rdbPG);
